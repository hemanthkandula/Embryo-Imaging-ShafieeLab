...
public class SmartphoneActivity extends AppCompatActivity  implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            ...
            cameraDevice.close();
            mCameraDevice = null;
            Activity activity = SmartphoneActivity.this;
            if (null != activity) {
                activity.finish();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mpicturebutton = findViewById(R.id.camera_capture_button);
    ...
    private void showToast(final String text) {
        final Activity activity = SmartphoneActivity.this;
        if (activity != null) {
...
//        }
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static SmartphoneActivity.ErrorDialog newInstance(String message) {
            SmartphoneActivity.ErrorDialog dialog = new SmartphoneActivity.ErrorDialog();
